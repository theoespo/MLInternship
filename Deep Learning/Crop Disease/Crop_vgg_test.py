...
conv_base = keras.applications.VGG19(weights="imagenet", include_top=False, input_shape=(224, 224, 3), pooling='avg')
...
new_test_target_name = [fname for fname in os.listdir(test_dir)]
new_test_target = []
for f in new_test_target_name:
